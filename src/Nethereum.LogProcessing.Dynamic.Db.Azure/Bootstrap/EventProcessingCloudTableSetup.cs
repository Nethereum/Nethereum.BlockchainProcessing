...
using Nethereum.LogProcessing.Dynamic.Db.Azure.Repositories;

namespace Nethereum.LogProcessing.Dynamic.Db.Azure.Bootstrap
{
    public class EventProcessingCloudTableSetup : CloudTableSetupBase
    {
        ...
        public CloudTable GetSubscriberStorageTable() => GetPrefixedTable("SubscriberStorageRepos");
        ...
        public ISubscriberStorageRepository GetSubscriberStorageRepository() => new SubscriberStorageRepository(GetSubscriberStorageTable());
    }
}
