...
using Nethereum.LogProcessing.Dynamic.Handling.Handlers.Handlers;
using Nethereum.RPC.Eth.DTOs;
using System.Threading.Tasks;
using Xunit;

namespace Nethereum.LogProcessing.Dynamic.Tests.Handlers
{
    public class EventHandlerFactoryTests
    {
        ...
        Mock<IEthApiContractService> _ethApiMock = new Mock<IEthApiContractService>();
